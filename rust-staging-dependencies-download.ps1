...
$depotArgs = "-app 258550 -branch staging -depot 258551 -filelist $fileListPath -dir $rustDir"
...
Invoke-WebRequest -Uri "https://downloads.oxidemod.com/artifacts/Oxide.Rust/staging/Oxide.Rust.zip" -OutFile "$oxideDir\Oxide.Rust.zip"
